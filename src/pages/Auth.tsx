...
const Auth: React.FC = () => {
  ...
  // Detect if running inside native iOS shell with native auth
  const { isNativeAuthEnabled } = useNativeShell();
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          {/* Social Login Buttons - Hidden when native shell handles auth */}
          {!isNativeAuthEnabled && (
          ...
          {/* Native Auth Placeholder - Shows when native shell handles auth */}
          {isNativeAuthEnabled && (
            <div className="text-center py-4">
              <p className="text-sm text-muted-foreground">
                Use the native buttons above to sign in
              </p>
            </div>
          )}
        </motion.form>
