...
import { ArrowLeft, Music, User, Calendar, MessageCircle, Crown } from 'lucide-react';
...
import { DJSubscriptionCard } from '@/components/dj/DJSubscriptionCard';
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-lg border-b border-border/50 px-4 py-3">
          <div className="flex items-center justify-between">
            <Button variant="ghost" size="sm" onClick={() => navigate('/djs')}>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">
                  {profile ? t('djDashboard') : t('becomeDJ')}
                </h1>
                <p className="text-sm text-muted-foreground">
                  {profile ? t('manageYourDJProfile') : t('createProfileGetGigs')}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          {!profile ? (
            ...
            <Tabs defaultValue={isSubscribed ? "requests" : "subscription"}>
              ...
              <TabsContent value="profile">
                <DJProfileForm existingProfile={profile} />
              </TabsContent>
